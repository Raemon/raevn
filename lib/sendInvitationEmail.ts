...
// /admin TipTap editor plus the guest's personal link — no generated copy.
// Only ever called from the send-invitations route when a host clicks Send.
...
export async function sendInvitationEmail(
  ...
  if (!invitee.invitationHtml) return { ok: false, reason: 'no invitation content written yet' };

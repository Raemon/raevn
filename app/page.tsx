...
const LockedShell = () => (
  <main className="relative min-h-svh w-full overflow-hidden bg-black text-[#ecedf1]">
    ...
    <div className="relative z-10 flex min-h-svh flex-col items-center justify-start gap-8 px-6 pt-[55vh] pb-16 text-center">
      <h1
        className={`${playfair.className} m-0 text-[clamp(1.9rem,9.2vw,2.25rem)] md:text-[clamp(2.2rem,5.4vw,4.2rem)] font-normal italic leading-[1.04] text-[#ecedf1]`}
      >
      ...
      <p
        className={`${cormorant.className} m-0 max-w-md px-6 text-[clamp(1rem,1.6vw,1.3rem)] font-light italic leading-[1.5] tracking-[0.04em] text-[#c2c6cd]`}
      >
